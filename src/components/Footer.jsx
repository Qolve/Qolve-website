        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-white text-[#0f172a] flex items-center justify-center font-bold">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold text-white mb-4 uppercase tracking-widest text-[11px] font-mono-code">Contact</h4>
            <button 
              onClick={onOpenContact}
              className="btn-figma-lime uppercase text-xs"
            >
              Get Started
            </button>
          </div>
