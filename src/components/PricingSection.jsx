...
export default function PricingSection() {
  ...
  return (
    <section className="section_pricing" id="pricing" style={{ position: 'relative', overflow: 'hidden', padding: '6rem 0', background: '#121413' }}>
      <div className="padding-global">
        <div className="container-large" style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <h2 style={{ fontFamily: 'Hanken Grotesk, sans-serif', fontSize: 'clamp(2.25rem, 4.5vw, 3.5rem)', color: '#e2e3e0', letterSpacing: '-0.025em', lineHeight: 1.15, fontWeight: 600, marginBottom: '1rem', maxWidth: '42rem' }}>
              Predictable pricing for growing teams
            </h2>

            <p style={{ color: '#c1c8c3', fontSize: '1.0625rem', lineHeight: 1.6, maxWidth: '36rem', marginBottom: '2rem' }}>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '9999px',
                  border: 'none',
                  background: isAnnual ? '#2d4b3e' : 'transparent',
                  color: isAnnual ? '#e2e3e0' : '#8b928d',
                  fontWeight: 500,
                  fontSize: '0.875rem',
                  cursor: 'pointer',
              ...
              >
                ...
                <span style={{ fontSize: '0.7rem', padding: '0.1rem 0.4rem', borderRadius: '9999px', background: 'rgba(173, 206, 189, 0.2)', color: '#adcebd', fontWeight: 600 }}>
                  Save 20%
                </span>
              </button>
            </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    gap: '2rem',
                    position: 'relative',
                    border: plan.isTop ? '1px solid rgba(173, 206, 189, 0.35)' : '1px solid rgba(255, 255, 255, 0.1)',
                  }}
                >
                  {plan.isTop && (
                    <div
                  ...
                  <div style={{ position: 'relative', zIndex: 2 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', marginBottom: '0.75rem' }}>
                      ...
                      <span style={{ fontFamily: 'Hanken Grotesk, sans-serif', fontSize: '1.25rem', fontWeight: 600, color: '#e2e3e0' }}>{plan.name}</span>
                    </div>

                    <div style={{ color: '#c1c8c3', fontSize: '0.9375rem', lineHeight: 1.6, minHeight: '3rem', marginBottom: '1.5rem' }}>
                      {plan.description}
                    </div>

                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.35rem', marginBottom: '1.75rem', paddingBottom: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                      <div style={{ fontFamily: 'Hanken Grotesk, sans-serif', fontSize: '3rem', fontWeight: 700, color: '#e2e3e0', letterSpacing: '-0.03em' }}>
                        ${currentPrice}
                      </div>
                      <div style={{ color: '#8b928d', fontSize: '0.875rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                      {plan.features.map((feat, j) => (
                        <div key={j} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.65rem' }}>
                          <CheckIcon />
                          <span style={{ color: '#c1c8c3', fontSize: '0.875rem', lineHeight: 1.5 }}>{feat}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <a
                    ...
                    style={{
                      ...
                      background: plan.isTop ? '#2d4b3e' : 'rgba(255, 255, 255, 0.05)',
                      color: plan.isTop ? '#e2e3e0' : '#e2e3e0',
                      border: plan.isTop ? '1px solid rgba(173, 206, 189, 0.35)' : '1px solid rgba(255, 255, 255, 0.1)',
                      padding: '0.85rem',
                      borderRadius: '0.5rem',
                      fontWeight: 500,
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = plan.isTop ? '#375d4d' : 'rgba(255, 255, 255, 0.1)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = plan.isTop ? '#2d4b3e' : 'rgba(255, 255, 255, 0.05)'
                    }}
                  >
