      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span className="font-mono-code text-xs font-bold uppercase tracking-widest text-slate-500 bg-white px-3 py-1 rounded-full border border-slate-200">
              About Qolve
            </span>

            <h2 className="font-heading text-3xl sm:text-4xl font-black text-[#0b1120] tracking-tight leading-tight">
            ...
            <div className="pt-4">
              <button onClick={onOpenContact} className="btn-dark uppercase text-xs">
                Contact Our Team
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-white p-8 rounded-3xl border border-slate-200 shadow-xl space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#0b1120] text-white flex items-center justify-center font-bold">
            ...
            <div className="space-y-4 text-xs sm:text-sm">
              <div className="p-4 bg-[#f2f8fc] rounded-2xl border border-slate-200">
                <span className="font-bold text-[#0b1120] block mb-1">Clear Execution</span>
                <span className="text-slate-600">No jargon or corporate fluff. We deliver clean, working code.</span>
              </div>
              <div className="p-4 bg-[#f2f8fc] rounded-2xl border border-slate-200">
                <span className="font-bold text-[#0b1120] block mb-1">Human-Centered Design</span>
